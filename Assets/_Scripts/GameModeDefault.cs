    ...
    public IEnumerator StartGame(List<QuestionScriptable> questions)
    {
        ...
        if (questions.Count <= 10)
        {
            ...
            openReward.onClick.AddListener(delegate{   
                OpenWinChest(Chest.ChestType.Small); GameManager.Instance.Menu.SetActive(true); awardWindow.SetActive(false); gameplayWindow.SetActive(true);});
        ...
        else if (questions.Count > 10 && questions.Count <= 25)
        {
            ...
            openReward.onClick.AddListener(delegate{   
                OpenWinChest(Chest.ChestType.Big); GameManager.Instance.Menu.SetActive(true); awardWindow.SetActive(false); gameplayWindow.SetActive(true); });
        ...
        else
        {
            ...
            openReward.onClick.AddListener(delegate{   
                OpenWinChest(Chest.ChestType.Large); GameManager.Instance.Menu.SetActive(true); awardWindow.SetActive(false); gameplayWindow.SetActive(true);});
